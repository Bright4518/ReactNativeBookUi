...
const BookDetail = ({ route, navigation }) => {
    ...
    function renderBookDescription() {
        ...
        const difference = scrollViewVisibleHeight >
            indicator ? scrollViewVisibleHeight - indicatorSize:1
        return (
            ...
            >
                ...
                <Text style={{...FONTS.body2,color:COLORS.lightGray2}}>{ book.description}</Text>
                </ScrollView>
                </View>
        )
    }
