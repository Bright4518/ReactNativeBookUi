...
const Home = ({navigation}) => {
    ...
    const bookOtherWordsForHome = {
        ...
        bookCover: images.otherWordForHome,
        rating: 4.5,
        language: 'Eng',
        pageNo: 341,
        ...
        readed: "12k",
        description: "Jude Never thought she'd be leaving her beloved older brother and father behind, all the wayacross the ocean in Syria. But when things in her howetown start becoming wolatile, Jude and her mother are sent to live in Cincinnati with relatives.",
        ...
        return (
            ...
            >
                ...
                ><Text style={{...FONTS.h2,color:COLORS.white}}>My Book</Text>
                    ...
                    >
                        <Text style={{
                            ...FONTS.body3, color: COLORS.lightGray,
